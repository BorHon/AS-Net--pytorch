...
class DataPath:
    def __init__(self):
        ...
        path=dict()
        path["image"]=r"F:\CV project\shanghaitech\part_B_final\train_data\images"
        path['gt'] =r"F:\CV project\shanghaitech\part_B_final\train_data\ground_truth"
        path['roi'] = None
        self.data_path["shanghaitechBtrain"]=path

        path = dict()
        path["image"] = r"F:\CV project\Crowd-Data\input_data\shanghaitech_partb\shanghaitech_part_B_patches_9\img"
        path['gt'] = r"F:\CV project\Crowd-Data\input_data\shanghaitech_partb\shanghaitech_part_B_patches_9\den"
        path['roi'] = None
        self.data_path["shanghaitechB_train"] = path

        path=dict()
        path["image"] = r"F:\CV project\Crowd-Data\part_A_final\train_data\images"
        path['gt'] = r"F:\CV project\Crowd-Data\part_A_final\train_data\ground_truth"
        path['roi'] = None
        self.data_path["shanghaitechA_val"] = path
        ...
        for base_path in self.base_path_list:
            for key in data_path_dict:
                if data_path_dict[key] is not None:
                    ...
                    this_abs_path=data_path_dict[key]
