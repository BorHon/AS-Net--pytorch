...
def multithread_dataloader(data_config):
    ...
    for name in data_config:
        ...
        this_dataloader = DataLoader(this_data, batch_size=batch_size, shuffle=is_shuffle, num_workers=0, drop_last=False, worker_init_fn=worker_init_fn)
